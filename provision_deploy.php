			...
			<div class="col-md-12">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						...
						Remote Path: <b><?php echo $provision_path_remote; ?></b>
						<br><br>
						Devices to Deploy: <b><?php echo phone_count_np();?></b>
						<br><br>
						<font size=3><a href="provision_deploy_page1.php">[BEGIN DEPLOYMENT]</a></font>
						<br><br>
