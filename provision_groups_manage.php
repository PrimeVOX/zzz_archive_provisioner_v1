...
<div class="content">
	...
	<div class="page-header">
		<h1 class="title"><a href="provision_groups.php">Group Management</a> > Edit</h1>
		<ol class="breadcrumb">
			...
			<div class="col-md-12">
				<div class="panel panel-default">
					...
					<div class="panel-body table-responsive">
						<?php echo '<form action="provision_groups_manage_submit.php?group_number='.$_GET['group_number'].'" method="POST">'; ?>
							<div class="form-group">
								<label for="input002" class="col-sm-2 control-label form-label">Group Number</label>
								<div class="col-sm-10">
									<b>Group <?php echo $_GET['group_number']; ?></b>
								</div>
							</div>
							<br><br>
							<div class="form-group">
								...
								<div class="col-sm-10">
									<?php
										$con = new PDO("mysql:host=localhost","root","76542891374");
										if ($con)
										{
											$con->query("USE pvx_provisioner");
											$q1 = $con->query("SELECT * FROM provisioner_group_definitions WHERE group_number=".$_GET['group_number']);
											$groupName = "";
											if ($q1 && $q1->rowCount()>0)
											{
												$a1=$q1->fetch();
												$groupName=urldecode($a1['group_name']);
											}
											echo '<input type="text" class="form-control" name="group_name" placeholder="" value="'.$groupName.'">';
										}
									?>
								</div>
							</div>
